  ...
  const ListItem = ({ pairAddress, index }) => {
    ...
    if (pairData && pairData.token0 && pairData.token1) {
      ...
      const apy = formattedPercent(
        (pairData.oneDayVolumeUSD * 0.002 * 365 * 100) / pairData.reserveUSD
      );
      ...
      return (
        ...
        >
          ...
          {!below1080 && (
            <DataText area="fees">
              {formattedNum(pairData.oneDayVolumeUSD * 0.002, true)}
            </DataText>
          )}
    ...
    Object.keys(pairs)
      .sort((addressA, addressB) => {
        ...
        if (sortedColumn === SORT_FIELD.APY) {
          const apy0 =
            parseFloat(pairA.oneDayVolumeUSD * 0.002 * 356 * 100) /
            parseFloat(pairA.reserveUSD);
          const apy1 =
            parseFloat(pairB.oneDayVolumeUSD * 0.002 * 356 * 100) /
